...
<%@ page import="ec.edu.gr03.model.Movimiento" %>
                    ...
                    <% } else { %>
                        <table class="data-table">
                            ...
                            <tbody>
                                ...
                                %>
                                <tr>
                                    <td><%= mov.getNroMov() != null ? mov.getNroMov() : "N/A" %></td>
                                    <td>
                                        <%= mov.getFecha() != null ? mov.getFecha() : "N/A" %>
                                    </td>
                                    <td><%= mov.getTipo() != null ? mov.getTipo() : "N/A" %></td>
                                    <td><%= mov.getAccion() != null ? mov.getAccion() : "N/A" %></td>
                                    <td style="text-align: right;">
                                        $<%= String.format("%.2f", mov.getImporte() != null ? mov.getImporte() : 0.0) %>
                                    </td>
                                </tr>
                                <% } %>
                            </tbody>
