...
public class BalancesFrm extends javax.swing.JFrame {
    ...
    /**
     * Carga los balances desde el servicio REST y los muestra en la tabla.
     */
    private void cargarBalances() {
        try {
            ...
            // Obtener los balances del servicio REST
            List<ec.edu.gr03.controller.Cuenta> balances =
            ...
            for (ec.edu.gr03.controller.Cuenta cuenta : balances) {
                ...
                fila[0] = cuenta.getNumeroCuenta() != null ? cuenta.getNumeroCuenta() : "";
                fila[1] = cuenta.getNombreCliente() != null ? cuenta.getNombreCliente() : "";
                fila[2] = df.format(cuenta.getSaldo());
                fila[3] = cuenta.getEstado() != null ? cuenta.getEstado() : "";
